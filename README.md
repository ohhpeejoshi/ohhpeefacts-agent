...
OhhpeeFacts is an early stage lightweight Python automation bot that generates a lesser-known, surprising fact using the Gemini API, alongside a ready-to-post Instagram caption. It then uses Pillow to create a professional, branded 1080x1080 graphic, and automatically runs every day at 9:00 AM Asia/Kolkata via GitHub Actions.
